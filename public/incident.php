...
<body class="dashboard-body">
    <div class="d-flex" id="layoutWrapper">
        <?php $activeMenu = 'incident'; include __DIR__ . '/partials/sidebar.php'; ?>
                            ...
                            <div class="card-body">
                                ...
                                <form id="incidentForm" class="row g-3">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <small class="text-muted d-block mb-1">Select up to two users in order: first is Checked By, second is Approved By.</small>
                                    ...
                                    <div class="col-12 d-flex justify-content-end gap-2"><button type="reset"
                                            ...
                                            class="btn btn-sm btn-primary" id="saveIncidentBtn"><span
                                                class="spinner-border spinner-border-sm d-none"></span><span class="btn-label">Save
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table table-sm table-hover align-middle" id="incidentsTable">
                                        ...
                                        <tbody><?php if (empty($incidents)): ?><tr>
                                                <td colspan="6" class="text-center text-muted small py-3">No incident
                                                    reports found.</td>
                                            </tr><?php else: foreach ($incidents as $incident): ?><tr>
                                                ...
                                                <td>
                                                    ...
                                                    ?>
                                                    <span class="badge <?php echo $statusClass; ?>"><?php echo htmlspecialchars(ucfirst($status)); ?></span>
                                                </td>
                                                <td class="text-end"><button class="btn btn-sm btn-outline-primary"
                                                        type="button"
                                                        title="View incident details" aria-label="View incident details" onclick="viewIncident(<?php echo htmlspecialchars(json_encode($incident), ENT_QUOTES, 'UTF-8'); ?>)"><i
                                                            class="bi bi-eye"></i></button><button
                                                        class="btn btn-sm btn-outline-secondary ms-1" type="button"
                                                        title="Print incident" aria-label="Print incident" onclick="printIncident(<?php echo htmlspecialchars(json_encode($incident), ENT_QUOTES, 'UTF-8'); ?>)"><i
                                                            class="bi bi-printer"></i></button><button
                                                        class="btn btn-sm btn-outline-success ms-1" type="button"
                                                        title="Approve or check incident" aria-label="Approve or check incident" onclick="approveIncident(<?php echo htmlspecialchars(json_encode($incident), ENT_QUOTES, 'UTF-8'); ?>)"><i
                                                            class="bi bi-check-circle"></i></button><button
                                                        class="btn btn-sm btn-outline-danger ms-1" type="button"
                                                        title="Reject incident" aria-label="Reject incident" onclick="rejectIncident(<?php echo htmlspecialchars(json_encode($incident), ENT_QUOTES, 'UTF-8'); ?>)"><i
    ...
    <div class="modal fade" id="incidentModal" tabindex="-1">
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                ...
                <div class="modal-footer"><button type="button" class="btn btn-outline-primary" id="modalEditIncident" title="Edit incident" aria-label="Edit incident"><i class="bi bi-pencil"></i></button><button type="button" class="btn btn-outline-danger" id="modalDeleteIncident" title="Delete incident" aria-label="Delete incident"><i class="bi bi-trash"></i></button><button type="button" class="btn btn-primary" id="modalPrintIncident" title="Print incident" aria-label="Print incident"><i
